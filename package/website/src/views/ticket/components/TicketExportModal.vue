    ...
    <div class="flex flex-col gap-4 py-2">
      ...
      <div class="grid grid-cols-1 gap-3">
        <button 
          ...
          class="flex items-center justify-between p-4 rounded-xl dark:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:border-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/10 transition-all group"
        >
          <div class="flex items-center gap-3">
            ...
            <div class="text-left">
              <div class="font-bold text-slate-800 dark:text-white group-hover:text-orange-600 dark:group-hover:text-orange-400">JSON 格式</div>
        ...
        <button 
          ...
          class="flex items-center justify-between p-4 rounded-xl dark:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:border-green-500 hover:bg-green-50 dark:hover:bg-green-900/10 transition-all group"
        >
          <div class="flex items-center gap-3">
        ...
        <button 
          ...
          class="flex items-center justify-between p-4 rounded-xl dark:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:border-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/10 transition-all group disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <div class="flex items-center gap-3">
